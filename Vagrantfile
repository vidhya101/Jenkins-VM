...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "JenkinsServer" do |jenkins|
        ...
        jenkins.vm.box = "ubuntu/focal64"  # Ubuntu 20.04 LTS
    ...
    config.vm.define "NexusServer" do |nexus|
        ...
        nexus.vm.box = "ubuntu/focal64"  # Changed to Ubuntu 20.04 LTS
    ...
    config.vm.define "SonarServer" do |sonar|
        ...
        sonar.vm.box = "ubuntu/focal64"  # Changed from bionic64 to focal64
